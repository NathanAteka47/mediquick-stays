  ...
  const faqs = [
    {
      ...
      answer: "Check-in time is 2:00 PM. Early check-in requests are subject to room availability."
    },
    {
      question: "Is breakfast included as standard with all rooms?",
      answer: "Breakfast is available as an additional service. You can add it during your booking process."
    },
    {
      question: "Do you provide a child day care service?",
      answer: "While we offer child-friendly facilities, we don't provide daycare services. Please inquire for special needs."
    }
  ];
      ...
      <section className="bg-gradient-to-r from-indigo-500 to-purple-600 text-white py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Standard Package</h1>
            <p className="text-xl mb-8">Comfortable Room - Essential Amenities</p>
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 inline-block">
              <div className="text-3xl font-bold">From Ksh3,500 / Night</div>
            </div>
          </div>
        </div>
      </section>
