  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-xl font-bold text-gray-800 mb-6 text-center">Our Values</h2>
            
            <div className="space-y-6">
              {/* Ubuntu */}
              <div className="bg-blue-50 rounded-lg p-4 border-l-4 border-blue-500">
                <h3 className="text-base font-bold text-gray-800 mb-2">Ubuntu</h3>
              ...
              <div className="bg-pink-50 rounded-lg p-4 border-l-4 border-pink-500">
                <h3 className="text-base font-bold text-gray-800 mb-2">Compassion</h3>
              ...
              <div className="bg-green-50 rounded-lg p-4 border-l-4 border-green-500">
                <h3 className="text-base font-bold text-gray-800 mb-2">Respect</h3>
                <p className="text-gray-600 text-sm">
              ...
              <div className="bg-purple-50 rounded-lg p-4 border-l-4 border-purple-500">
                <h3 className="text-base font-bold text-gray-800 mb-2">Excellence</h3>
                <p className="text-gray-600 text-sm">
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-xl font-bold text-gray-800 mb-6 text-center">Our Medical Equipment & Facilities</h2>
            
            {/* Hospital Bed Feature */}
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-6 mb-6 border border-blue-200">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-center">
                <div>
                  <h3 className="text-base font-bold text-gray-800 mb-3">Professional Hospital Beds</h3>
                ...
                <div className="bg-white rounded-lg p-4 shadow-md border border-gray-200">
                  <div className="text-center">
                    <div className="text-4xl mb-3">
                      <img src="/crankbed.jpg" alt="Medical Crank Bed" className="w-full h-auto rounded" />
                    </div>
                    <h4 className="font-bold text-gray-800 mb-1 text-sm">Medical-Grade Comfort</h4>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {[
                {
                  icon: <img src='/wheelchair.jpg' alt='Wheelchair' className='w-20 h-20 object-cover rounded' />,
                  title: "Mobility Aids",
                  description: "Wheelchairs, walkers, and mobility scooters for easy movement"
                },
                {
                  icon: <img src='/medication.jpg' alt='Medication Management' className='w-20 h-20 object-cover rounded' />,
                  title: "Medication Management",
                  description: "Locked storage and organization systems for medications"
                },
                {
                  icon: <img src='/stethoscope.jpg' alt='Vital Signs Monitors' className='w-20 h-20 object-cover rounded' />,
                  title: "Vital Signs Monitors",
                  description: "Digital blood pressure, pulse oximeters, and thermometers"
                },
                {
                  icon: <img src='/water.jpg' alt='Hydration Equipment' className='w-20 h-20 object-cover rounded' />,
                  title: "Oxygen Equipment",
                  description: "Oxygen concentrators and delivery systems available"
                },
                {
                  icon: <img src='/rehab.jpg' alt='Rehabilitation Equipment' className='w-20 h-20 object-cover rounded' />,
                  title: "Therapy Equipment",
                  description: "Basic physical therapy and rehabilitation tools"
                },
                {
                  icon: <img src='/emergency.jpg' alt='Emergency Equipment' className='w-20 h-20 object-cover rounded' />,
                ...
                <div key={index} className="bg-gray-50 rounded-lg p-4 border border-gray-200 hover:border-blue-300 transition-colors">
                  <div className="mb-2 flex justify-center">{equipment.icon}</div>
                  <h4 className="font-semibold text-gray-800 mb-1 text-sm">{equipment.title}</h4>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-xl font-bold text-gray-800 mb-6 text-center">Our Comprehensive Amenities</h2>
            
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {/* Medical Services */}
              <div className="space-y-3">
                <h3 className="text-base font-semibold text-gray-800 mb-3 border-b pb-2">Medical Services</h3>
                {[
              ...
              <div className="space-y-3">
                <h3 className="text-base font-semibold text-gray-800 mb-3 border-b pb-2">Accommodation Features</h3>
                {[
              ...
              {/* Support Services */}
              <div className="space-y-3">
                <h3 className="text-base font-semibold text-gray-800 mb-3 border-b pb-2">Support Services</h3>
                {[
                  "Airport Transfers",
        ...
        <div className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white rounded-xl shadow-lg p-6">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-xl font-bold mb-4">Strategic Medical Location</h2>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 max-w-2xl mx-auto">
              {[
                ...
                <div key={index} className="bg-white/10 rounded-lg p-2 backdrop-blur-sm">
                  <div className="font-semibold text-sm">{location.hospital}</div>
                  <div className="text-xs opacity-80">{location.time}</div>
                </div>
              ))}
            </div>
          </div>
