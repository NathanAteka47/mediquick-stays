      ...
      <div className="container mx-auto px-4 max-w-2xl">
        <div className="bg-white rounded-xl shadow-lg p-6">
          <div className="text-center mb-4">
            ...
            <p className="text-gray-500 text-sm">Thank You for choosing Mediquick Stays!</p>
          </div>

          <div className="bg-green-50 border border-green-200 rounded p-3 mb-4">
            <h3 className="font-semibold text-green-800 mb-1 text-sm">What happens next?</h3>
          ...
          <div className="bg-gray-50 rounded p-4 mb-4">
            <h3 className="font-semibold text-gray-800 mb-3 text-sm">Booking Details</h3>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded p-3 mb-4">
            <h3 className="font-semibold text-blue-800 mb-1 text-sm">📱 Your Booking is Safe</h3>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link
              to="/my-account"
              className="bg-indigo-600 text-white px-4 py-2 rounded hover:bg-indigo-700 transition-colors font-semibold text-center text-sm"
            >
              View My Bookings
            </Link>
            <Link
              to="/"
              className="bg-white text-indigo-600 border border-indigo-600 px-4 py-2 rounded hover:bg-indigo-50 transition-colors font-semibold text-center text-sm"
            >
              Back to Home
            </Link>
            <Link
              to="/bookings"
              className="border border-gray-300 text-gray-700 px-4 py-2 rounded hover:bg-gray-50 transition-colors font-semibold text-center text-sm"
            >
